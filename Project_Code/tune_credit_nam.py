...
def _run_trial(
  ...
  """Runs one training trial and returns validation/test PRAUC."""
  ...
  return validation_prauc, test_prauc, trial_logdir
...
def _objective(trial: optuna.Trial):
  ...
  validation_prauc, test_prauc, trial_logdir = _run_trial(
      trial.number,
      output_regularization=output_regularization,
      l2_regularization=l2_regularization,
      dropout=dropout,
