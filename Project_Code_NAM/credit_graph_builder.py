...
def build_graph(
  ...
  train_pr_metric = functools.partial(
      pr_auc_score,
      y_true=y_train,
      pred_tensor=y_pred,
      dataset_init_op=train_init_op,
  )
  test_pr_metric = functools.partial(
      pr_auc_score,
      y_true=y_test,
      pred_tensor=y_pred,
      dataset_init_op=test_init_op,
  )
  train_auc_metric = functools.partial(
      roc_auc_score,
      y_true=y_train,
      pred_tensor=y_pred,
      dataset_init_op=train_init_op,
  )
  test_auc_metric = functools.partial(
      roc_auc_score,
      y_true=y_test,
      pred_tensor=y_pred,
      dataset_init_op=test_init_op,
  ...
  eval_metric_scores = {
      "test_pr": test_pr_metric,
      "train_pr": train_pr_metric,
      "test_auc": test_auc_metric,
      "train_auc": train_auc_metric,
  }
...
def build_eval_graph(
  ...
  eval_pr_metric = functools.partial(
      pr_auc_score,
      y_true=y_eval,
      pred_tensor=y_pred,
      dataset_init_op=eval_init_op,
  )
  eval_auc_metric = functools.partial(
      roc_auc_score,
      y_true=y_eval,
      pred_tensor=y_pred,
      dataset_init_op=eval_init_op,
  ...
  return {
      ...
      "pr_auc": eval_pr_metric,
      "roc_auc": eval_auc_metric,
  }
